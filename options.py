...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument(
            "--log_frequency",
            type=int,
            help="number of batches between each tensorboard/W&B log",
            default=400,
        )
        self.parser.add_argument(
            "--save_frequency",
        ...
        self.parser.add_argument(
            ...
            help=(
                "if set assume we are loading eigen results from npy but "
        ...
        self.parser.add_argument(
            "--post_process",
            help=(
                "if set will perform the flipping post processing "
